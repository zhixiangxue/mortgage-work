...
class OpenFolderDialog:
    ...
    # .NET 8+ removed FileDialogNative+IFileDialog (internal COM wrapper).
    # The Vista-style folder picker reflection hack no longer works.
    _use_fallback = iFileDialogType is None
    ...
    def show(cls, parent=None, initialDirectory=None, allow_multiple=False, title=None):
        if cls._use_fallback:
            ...
            result = dlg.ShowDialog(parent) if parent else dlg.ShowDialog()
